	...
	<div class="product-section mt-150 mb-150">
      ...
      <?php
            $hh=new hanghoa();
            $result=$hh->getHangHoaNew();//lấy ra đc 12 sản phẩm
        	...
        	<div class="row clearfix">
            	...
            	<div class="image-column col-lg-6">
                	<div class="image">
                    	...
                    	<img src="Content/assets/img/a.jpg" alt="">
                    </div>
                </div>
                <!--Content Column-->
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="Content/assets/img/avaters/avatar1.png" alt="">
							</div>
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="Content/assets/img/avaters/avatar2.png" alt="">
							</div>
							<div class="client-meta">
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="Content/assets/img/avaters/avatar3.png" alt="">
							</div>
							<div class="client-meta">
